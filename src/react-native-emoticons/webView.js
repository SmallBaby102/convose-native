  ...
  render() {
    return (
      <View
        style={[
          styles.container,
          Platform.OS === "android" ? { marginTop: 21 } : { marginTop: 21 },
        ]}
        visible="hidden"
      >
        <View style={styles.toolbar}>
          ...
          >
            <Image style={styles.leftIOS} source={backImg} />
          </TouchableOpacity>

          <View style={styles.titleViewIOS}>
            <TouchableOpacity style={styles.titleViewIOSClick}>
              <Text style={styles.titleIOS}>表情商城</Text>
            </TouchableOpacity>
          </View>
        </View>
        <View style={styles.content}>
          <Text style={styles.tip}>Custom emoticons is on going</Text>
